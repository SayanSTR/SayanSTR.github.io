...
function useIntersectionObserver(elementRef, // Changed Element to HTMLElement | null
{ threshold = 0.1, // Default to 10% visibility
root = null, rootMargin = '0%', triggerOnce = true, // Default to triggering the animation only once
 } = {}) {
