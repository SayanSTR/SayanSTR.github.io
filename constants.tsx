...
export const BriefcaseIcon: React.FC<{className?: string}> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.073a2.25 2.25 0 01-2.25 2.25h-12a2.25 2.25 0 01-2.25-2.25V14.15M17.25 9.75V6.75A2.25 2.25 0 0015 4.5H9A2.25 2.25 0 006.75 6.75v3M12 11.25V14.25m0 0H9.75m2.25 0H14.25M3.75 9h16.5M12 6.75v.007" />
  </svg>
);
...
export const CloudIcon: React.FC<{className?: string}> = ({ className }) => (
 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15a4.5 4.5 0 004.5 4.5H18a3.75 3.75 0 001.332-7.257 3 3 0 00-5.433-2.264 4.5 4.5 0 00-8.232 4.015M12 12.75V15m0 0H9.75M12 15h2.25" />
  </svg>
);

export const DatabaseIcon: React.FC<{className?: string}> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h6m-6 3.75h6m-6 3.75h6M9 18h6" />
  </svg>
);
...
export const SKILLS_DATA: Skill[] = [
  { name: "Java", category: "Languages & Core Skills", icon: <CodeBracketIcon className={SKILL_ICON_CLASS}/> },
  { name: "Python", category: "Languages & Core Skills", icon: <CodeBracketIcon className={SKILL_ICON_CLASS}/> },
  { name: "Spring Boot", category: "Backend Frameworks", icon: <ServerStackIcon className={SKILL_ICON_CLASS}/> },
  { name: "Spring Framework", category: "Backend Frameworks", icon: <ServerStackIcon className={SKILL_ICON_CLASS}/> },
  { name: "Microservices", category: "Architecture", icon: <ServerStackIcon className={SKILL_ICON_CLASS}/> },
  { name: "RESTful APIs", category: "Backend Frameworks", icon: <ServerStackIcon className={SKILL_ICON_CLASS}/> },
  
  { name: "React", category: "Frontend & Learning", icon: <CodeBracketIcon className={SKILL_ICON_CLASS}/> },
  { name: "JavaScript", category: "Frontend & Learning", icon: <CodeBracketIcon className={SKILL_ICON_CLASS}/> },
  { name: "TypeScript", category: "Frontend & Learning", icon: <CodeBracketIcon className={SKILL_ICON_CLASS}/> },
  { name: "Node.js", category: "Frontend & Learning", icon: <ServerStackIcon className={SKILL_ICON_CLASS}/> },
  ...
  { name: "Git & GitHub", category: "Tools", icon: <GitHubIcon className={SKILL_ICON_CLASS}/> },
  { name: "Agile Development", category: "Methodologies", icon: <CodeBracketIcon className={SKILL_ICON_CLASS}/> },
];
